...
def test_streamlit_secrets_partial():
    ...
    try:
        # Don't set OPENAI_MODEL env var for this test
        # to verify it uses the default
        ...
        with patch.dict('sys.modules', {'streamlit': mock_st}):
            ...
            # Model should use default since not in secrets and not in env
        ...
        # Clean up any env vars that might have been set
        if 'OPENAI_MODEL' in os.environ:
            del os.environ['OPENAI_MODEL']
